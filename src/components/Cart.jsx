    ...
    <>
      <div className={`fixed right-0 top-0 w-full lg:w-[20vw] h-full p-5 bg-white mb-3 
        ...
        <div className="flex justify-between items-center my-3">
          ...
          className="border-2 border-gray-600 text-gray-600 fond-bold p-1 text-xl rounded-md hover:text-red-300
        ...
        <hr className="w-[90vw] lg:w-[18vw] my-2 mt-2"/>
        <button className="bg-green-500 font-bold px-3 text-white py-2 rounded-lg w-[90vw] lg:w-[18vw] mb-5 px-y"
        >
          Checkout
        </button>
      </div>
